...
mod tests {
    ...
    use super::{
        RepoItem, Tab, format_age, format_repo_detail, history_row, host_from_api_url,
        parse_repo_items, parse_repo_remote, parse_rich_text_segments, repo_row,
        strip_think_blocks, url_host,
    };
